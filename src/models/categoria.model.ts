...
@model({
  settings: {idInjection: false, mysql: {schema: 'bbddmysql', table: 'categoria'}}
})
export class Categoria extends Entity {
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'categoria_padre_id', dataType: 'int', dataLength: null, dataPrecision: 11, dataScale: 0, nullable: 'Y', generated: false},
  })
