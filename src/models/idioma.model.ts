...
@model({settings: {idInjection: false, mysql: {schema: 'bbddmysql', table: 'idioma'}}})
export class Idioma extends Entity {
  ...
  @property({
    ...
    scale: 0,
    generated: false,
    mysql: {columnName: 'usuario_inactivo', dataType: 'int', dataLength: null, dataPrecision: 10, dataScale: 0, nullable: 'Y', generated: false},
  })
